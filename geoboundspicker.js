  ...
  // Finally, as a browser global.
    ...
    var GeoBoundsPicker = function(element, options, cb) {
        ...
        this.template = '<div class="geoboundspicker dropdown-menu">' +
            ...
            '<button class="btn btn-sm applyBtn">'+this.settings.locale.applyLabel+'</button>' +
            '<button class="btn btn-sm cancelBtn">'+this.settings.locale.cancelLabel+'</button></div>' +
            ...
            '<label class="south"><input name="south" type="number" step="0.1"/><span>'+this.settings.locale.southLabel+'</span></label>'+
            '</form></div>' +
            '</div>';
        ...
        this.interactive = true; // TODO : should be settable
        ...
        this.container.find('.navigation')
              ...
              layers : [ 
                  new ol.layer.Tile({
                      source : new ol.source.TileWMS({
                          url : "https://data.knmi.nl/wms-map/cgi-bin/bgmaps.cgi", // TODO: MapBoxUtils.baseMapUrl,
                          params : {
                              'LAYERS' : "world_baselayer,world_overlay" // TODO: MapBoxUtils.baseMapLayers
                          }
                      })
                  })
              ],
